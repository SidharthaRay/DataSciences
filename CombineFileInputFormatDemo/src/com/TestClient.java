...
public class TestClient extends Configured implements Tool {
	...
	public static void main(String[] args) throws Exception {
		System.exit(ToolRunner.run(new Configuration(), new TestClient(), args));
	}
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(TestClient.class);
		FileInputFormat.addInputPath(job, new Path("resources/input"));
		job.setInputFormatClass(CombFileInputFormat.class);
